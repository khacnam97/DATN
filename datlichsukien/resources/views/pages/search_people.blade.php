...
<div class="container" style="margin-top: 200px;">
	<div style="margin-bottom: 200px; margin-top: 200px;">
		<p style="font-size: 30px;text-align: center;">Không Tìm thấy địa điểm có sức chứa trên 1000 người </p>
	</div>
</div>
@endif
@if(count($post)!=0)
<h1 style="margin-top:100px;margin-bottom: 50px; text-align: center;">Danh sách kết quả tìm kiếm </h1>
	<div style="text-align: center;">
		<span >Tìm thấy <strong>{{count($post)}}</strong> địa điểm có sức chứa trên 1000 người </span>
	</div>
@endif
