    ...
    <div class=" row align-middle" style=" color: white; margin-top: 50px; margin: 0px;">
      ...
      <div class="col-sm-3" >
        <div style="margin-top: 40px;">
          <h3><span>EVENT&nbsp;</span><span class="footer-logo " style="color: #3997A6;"></span></h3>
        </div>
        ...
        <p class="copyright" style="color: white">&copy 2019 Event</p><p class="copyright" style="color: white"> All rights reserved.</p>
